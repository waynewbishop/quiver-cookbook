...
The cookbook is comprised of interactive recipes for learning vector mathematics, numerical computing, and machine learning in Swift. Designed for developers exploring the math behind recommendation engines, search systems, and data analysis. Each recipe is a single `.swift` file that runs interactively inside Xcode — no app project, no build cycle, no boilerplate. Write a line, see the result immediately, modify the values, and watch the output change. This is powered by the Xcode 26 `#Playground` macro, which is designed for hands-on experimentation.
...
**01 — [How Far Is Home?](recipes/01-how-far-is-home.swift)**
...
**02 — [Normalize a Direction](recipes/02-normalize-a-direction.swift)**
...
**03 — [Are These Perpendicular?](recipes/03-are-these-perpendicular.swift)**
...
**04 — [Find the Most Similar Item](recipes/04-find-the-most-similar-item.swift)**
...
**05 — [King − Man + Woman = Queen](recipes/05-king-minus-man-plus-woman.swift)**
...
**06 — [Detect Near-Duplicates](recipes/06-detect-near-duplicates.swift)**
...
**07 — [Describe a Dataset](recipes/07-describe-a-dataset.swift)**
...
**08 — [Find the Outliers](recipes/08-find-the-outliers.swift)**
...
**09 — [Smooth a Noisy Signal](recipes/09-smooth-a-noisy-signal.swift)**
